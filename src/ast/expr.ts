 ...
 */
interface Between<Ext extends Extension = NoExtension> extends Tagged<'Between', {
 ...
 */
interface BinaryApp<Ext extends Extension = NoExtension> extends Tagged<'BinaryApp', {
 ...
 * ```
 */
interface Case<Ext extends Extension = NoExtension> extends Tagged<'Case', {
 ...
 */
interface Cast<Ext extends Extension = NoExtension> extends Tagged<'Cast', {
    readonly expr: Expr<Ext>,
 ...
 */
interface Collate<Ext extends Extension = NoExtension> extends Tagged<'Collate', {
    readonly expr: Expr<Ext>,
 ...
 */
interface Extract<Ext extends Extension = NoExtension> extends Tagged<'Extract', {
 ...
 */
interface FunctionApp<Ext extends Extension = NoExtension> extends Tagged<'FunctionApp', {
 ...
 * `IS [NOT] NULL`
 */
interface IsNull<Ext extends Extension = NoExtension> extends Tagged<'IsNull', {
    readonly negated: boolean,
    readonly expr: Expr<Ext>,
}> {};
 ...
 * `[NOT] IN (...list)`
 */
interface InList<Ext extends Extension = NoExtension> extends Tagged<'InList', {
    readonly negated: boolean,
    readonly expr: Expr<Ext>,
 ...
 * `[NOT] IN (subquery)`
 */
interface InSubQuery<Ext extends Extension = NoExtension> extends Tagged<'InSubQuery', {
    readonly negated: boolean,
    readonly expr: Expr<Ext>,
 ...
 */
interface Parenthesized<Ext extends Extension = NoExtension> extends Tagged<'Parenthesized', {
    readonly expr: Expr<Ext>
}> {};
 ...
 */
interface UnaryApp<Ext extends Extension = NoExtension> extends Tagged<'UnaryApp', {
