...
type Values<Ext extends Extension> = DefaultValues | ValuesConstructor<Ext> | ValuesQuery<Ext>;

interface DefaultValues extends Tagged<'DefaultValues', {}> {}
const DefaultValues = tag('DefaultValues', {});

interface ValuesConstructor<Ext extends Extension>
  extends Tagged<
    'ValuesConstructor',
    {
  ...
  > {}
const ValuesConstructor = <Ext extends Extension>(args: UnTag<ValuesConstructor<Ext>>): ValuesConstructor<Ext> =>
  tag('ValuesConstructor', args);

interface ValuesQuery<Ext extends Extension>
  extends Tagged<
    'ValuesQuery',
    {
  ...
  > {}
const ValuesQuery = <Ext extends Extension>(args: UnTag<ValuesQuery<Ext>>): ValuesQuery<Ext> =>
  tag('ValuesQuery', args);

interface Update<Ext extends Extension>
  extends Tagged<
    'Update',
    {
      readonly table: Ident;
...
interface UpdatePositioned<Ext extends Extension>
  extends Tagged<
    'UpdatePositioned',
    {
      readonly table: Ident;
  ...
  > {}
const UpdatePositioned = <Ext extends Extension>(args: UnTag<UpdatePositioned<Ext>>): UpdatePositioned<Ext> =>
  tag('UpdatePositioned', args);

interface Delete<Ext extends Extension>
  extends Tagged<
    'Delete',
    {
      readonly table: Ident;
...
interface DeletePositioned<Ext extends Extension>
  extends Tagged<
    'DeletePositioned',
    {
      readonly table: Ident;
  ...
  > {}
const DeletePositioned = <Ext extends Extension>(args: UnTag<DeletePositioned<Ext>>): DeletePositioned<Ext> =>
  tag('DeletePositioned', args);
