...
*/
interface DropSchema extends Tagged<'DropSchema', {
  readonly name: Ident,
...
*/
interface AlterTable<Ext extends Extension> extends Tagged<'AlterTable', {
  readonly name: Ident,
...
<drop column default clause> ::=
  DROP DEFAULT
*/
interface AlterColumn extends Tagged<'AlterColumn', {
  readonly name: Ident,
...
*/
interface DropColumn extends Tagged<'DropColumn', {
  readonly name: Ident,
  readonly behavior: DropBehavior,
}> { };
...
<add table constraint definition> ::=
  ADD <table constraint definition>
*/
interface AddTableConstraint extends Tagged<'AddTableConstraint', {
  readonly name: Ident,
...
*/
interface DropTableConstraint extends Tagged<'DropTableConstraint', {
  readonly name: Ident,
  readonly behavior: DropBehavior,
}> { };
...
*/
interface DropTable extends Tagged<'DropTable', {
  readonly name: Ident,
  readonly behavior: DropBehavior
}> { };
...
*/
interface DropView extends Tagged<'DropView', {
  readonly name: Ident,
  readonly behavior: DropBehavior
}> { };
...
*/
interface RevokePrivilege extends Tagged<'RevokePrivilege', {
...
*/
interface AlterDomain extends Tagged<'AlterDomain', {
  readonly name: Ident,
...
*/
interface SetDefault extends Tagged<'SetDefault', {
...
*/
interface AddDomainConstraint extends Tagged<'AddDomainConstraint', {
...
*/
interface DropDomainConstraint extends Tagged<'DropDomainConstraint', {
  readonly name: Ident
}> { };
const DropDomainConstraint = (args: UnTag<DropDomainConstraint>): DropDomainConstraint => tag('DropDomainConstraint', args);
...
*/
interface DropDomain extends Tagged<'DropDomain', {
  readonly name: Ident,
  readonly behavior: DropBehavior
}> { };
...
*/
interface DropAssertion extends Tagged<'DropAssertion', {
  readonly name: Ident,
  readonly behavior: DropBehavior
}> { };
